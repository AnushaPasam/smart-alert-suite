...
export default function PrincipalLayout({
  ...
  return (
    <div className="min-h-screen bg-background flex">
      {sidebarOpen && (
        <div
          className="fixed inset-0 bg-foreground/20 z-40 lg:hidden animate-fade-in-up"
      ...
      >
        ...
        <div className="p-3 border-t border-border space-y-1">
          <Link
            ...
            onClick={() => setSidebarOpen(false)}
            className={`flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-all duration-150 ${
              location.pathname === "/principal/profile"
        ...
        <header className="sticky top-0 z-30 bg-card/80 backdrop-blur-md border-b border-border px-4 sm:px-6 h-16 sm:h-20 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="lg:hidden p-2.5 rounded-xl bg-muted text-muted-foreground hover:text-foreground active:scale-95 ml-1"
