...
/**
 * Role-specific route modules for separate deployments
 */
...
function AnnouncerPanelRoutes() {
  return (
    <Routes>
      ...
      <Route
        path="/"
        element={<Navigate to="/announcer/dashboard" replace />}
      />
      <Route
        path="*"
        element={<Navigate to="/announcer/dashboard" replace />}
...
function AppRoutes() {
  ...
  if (panel === "admin") return <AdminPanelRoutes />;
  if (panel === "announcer") return <AnnouncerPanelRoutes />;
  if (panel === "principal") return <PrincipalPanelRoutes />;
  if (panel === "user") return <StudentPanelRoutes />;
