...
const features = [
  {
    ...
    desc: "Separate dashboards for principal, admin, announcer, and students.",
  },
  {
    icon: Filter,
    title: "Category Filtering",
    desc: "Filter announcements by academic, events, sports, and more.",
  },
  {
    icon: Bookmark,
    title: "Bookmark & Read",
    desc: "Students can bookmark important notices and track read status.",
  },
  {
    icon: BarChart3,
    title: "Analytics Dashboard",
    desc: "Get insights on announcement reach and engagement.",
  },
];
...
const steps = [
  {
    step: "01",
    title: "Campus Registers",
    desc: "Institution signs up and configures their campus portal.",
  },
  {
    step: "02",
    title: "Announcer Creates",
    desc: "Announcers create and submit announcements for approval.",
  },
  {
    step: "03",
    title: "Admin Reviews",
    desc: "Admin reviews and forwards to principal for final approval.",
  },
  {
    step: "04",
    title: "Students Receive",
    desc: "Students get real-time updates filtered by relevance and priority.",
  },
];
...
// Prefetch critical routes for better UX
const prefetchDashboards = () => {
  import("./user/Dashboard");
  import("./admin/Dashboard");
  import("./announcer/Dashboard");
};
...
export default function Index() {
  ...
  useEffect(() => {
    // Prefetch dashboards after landing page is interactive
    const timer = setTimeout(prefetchDashboards, 2000);
  ...
  const dashboardPath = user
    ? rolePaths[user.role] || "/user/dashboard"
    : "/user/login";
  ...
  return (
    <div className="min-h-screen bg-background overflow-x-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full flex items-center justify-between">
              ...
              {navLinks.map((link) =>
                link.type === "scroll" ? (
                  <button
                    ...
                    className={`text-sm font-bold tracking-tight transition-colors duration-300 relative py-2 ${
          ...
          <div className="flex md:hidden items-center gap-4">
            <button
              ...
              className={`p-2.5 rounded-xl transition-all active:scale-90 text-black ${
                scrolled
                  ? "bg-muted"
                  : "bg-white/10 backdrop-blur-md border border-black/20"
              }`}
                ...
                {navLinks.map((link, i) =>
                  link.type === "scroll" ? (
                    <motion.button
                      ...
                      className={`block w-full text-left text-2xl font-black transition-colors ${
                        activeSection === link.id
                          ? "text-primary"
                          : "text-foreground/60"
                      }`}
      ...
      <section id="home" className="min-h-screen flex flex-col">
        <InfiniteGrid className="flex-1 pt-16 sm:pt-20">
          <div className="w-full text-center px-4 sm:px-6 lg:px-8 py-10">
            ...
            >
              A modern, role-based platform for managing and receiving campus
              announcements efficiently. Keep your institution connected with
      ...
      <section
        id="features"
        className="campus-section bg-card border-y border-border"
      >
        <div className="campus-container">
          <Section>
            <div className="text-center mb-12">
              ...
              <p className="text-muted-foreground max-w-lg mx-auto">
                Everything you need to streamline campus communication in one
                platform.
              </p>
            </div>
          </Section>
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {features.map((f, i) => (
              <Section key={f.title}>
                <div
                  className="campus-card p-6 h-full"
        ...
        <div className="campus-container text-center">
          <Section>
            ...
            <p className="text-primary-foreground/80 mb-6 max-w-md mx-auto">
              Join institutions already using EduAlert to streamline their
              announcements.
            </p>
            <Link
              to={isAuthenticated ? dashboardPath : "/user/register"}
