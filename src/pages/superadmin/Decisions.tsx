...
export default function SuperAdminDecisions() {
  ...
  useEffect(() => {
    document.title = "Decision History – Super Admin";
  }, []);
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-1">
              Audit log of all approved and rejected announcements across the
              platform
            </p>
          </div>
                  ...
                  decisions.map((a) => (
                    ...
                    >
                        ...
                        <div className="flex items-center gap-2">
                          {a.status === "Approved by Principal" ? (
                            <>
                              ...
                              <span className="text-campus-olive font-medium">
                                Approved
                              </span>
                            </>
                          ) : (
                      ...
                      <td className="px-5 py-4 text-right whitespace-nowrap">
                        <Link
                          to={`/principal/announcement/${a.id}`}
