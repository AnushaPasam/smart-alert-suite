    ...
    <div className="space-y-6 max-w-3xl">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">
          Submit a new announcement for review
        </p>
      </div>
        ...
        {[
          {
            ...
            desc: "Suggested category: Academic",
          },
          {
            icon: AlertTriangle,
            title: "AI Priority Prediction",
            desc: "Predicted priority: Normal",
          },
          {
            icon: Clock,
            title: "Deadline Reminder",
            desc: "Reminder 2 days before expiry",
          },
          {
            icon: CalendarClock,
            title: "Schedule Extractor",
            desc: "Detected dates: March 15, 2026",
          },
        ].map((ai) => (
          <div
            key={ai.title}
