      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-6 py-12">
        ...
        <article className="campus-card-static p-6 sm:p-8 space-y-6">
          ...
          <p className="text-sm text-muted-foreground">
            Get in touch with the EduAlert team
          </p>
          ...
          <div className="grid sm:grid-cols-3 gap-4">
            {[
              ...
              { icon: Phone, label: "Phone", value: "+91 11 2345 6789" },
              {
                icon: MapPin,
                label: "Address",
                value: "NIT Delhi, New Delhi, India",
              },
            ].map((item) => (
              <div
                key={item.label}
                className="campus-card-static p-4 text-center"
              >
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            <button
              type="submit"
              disabled={isSubmitting}
              className="w-full py-2.5 rounded-lg bg-primary text-primary-foreground text-sm font-semibold hover:bg-campus-blue-hover transition-all duration-150 shadow-sm hover:shadow-md hover:-translate-y-0.5 disabled:opacity-50 disabled:cursor-not-allowed"
            >
