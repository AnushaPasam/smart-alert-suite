...
export default function PrivacyPolicy() {
  useEffect(() => {
    document.title = "Privacy Policy | Smart Campus Announcement System";
  }, []);
        ...
        <article className="campus-card-static p-6 sm:p-8 space-y-6">
          ...
          <section className="space-y-3">
            ...
            <p className="text-sm leading-relaxed text-muted-foreground">
              ...
              email address, branch affiliation, and role within the system. We
          ...
          <section className="space-y-3">
            ...
            <p className="text-sm leading-relaxed text-muted-foreground">
              Your information is used to provide and maintain the Smart Campus
              Announcement System, send relevant notifications, and improve our
          ...
          <section className="space-y-3">
            ...
            <p className="text-sm leading-relaxed text-muted-foreground">
              ...
              data. All data transmission is encrypted using SSL/TLS protocols.
            </p>
          </section>
