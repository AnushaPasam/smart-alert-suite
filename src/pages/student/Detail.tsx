    ...
    <div className="max-w-3xl mx-auto space-y-6">
      ...
      <article className="campus-card-static p-6 sm:p-8 space-y-5 animate-fade-in-up">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          <span
            className={`text-xs px-2 py-0.5 rounded-full font-medium ${priorityMap[a.priority]}`}
          >
        ...
        <div className="flex items-center gap-4 text-sm text-muted-foreground flex-wrap">
          <span className="inline-flex items-center gap-1">
            <Calendar className="h-3.5 w-3.5" /> Posted: {a.createdAt}
          </span>
          <span className="inline-flex items-center gap-1">
            <Clock className="h-3.5 w-3.5" /> Expires: {a.expiryDate}
          </span>
          <span className="inline-flex items-center gap-1">
            <Eye className="h-3.5 w-3.5" /> {a.views} views
          </span>
        </div>
