...
export default function AnnouncementDetail({ basePath = "/user" }: { basePath?: string }) {
  ...
  const handleDownloadPDF = () => {
    import('jspdf').then(({ jsPDF }) => {
      ...
      // Header
      doc.setFillColor(59, 130, 246); // campus blue
    ...
    <div className="max-w-3xl mx-auto space-y-6">
      ...
      <article className="campus-card-static p-6 sm:p-8 space-y-5 animate-fade-in-up">
        <div className="flex items-center gap-2 flex-wrap">
          ...
          <span className={`text-xs px-2 py-0.5 rounded-full font-medium ${a.status === "Published" ? "bg-campus-olive-light text-campus-olive" :
