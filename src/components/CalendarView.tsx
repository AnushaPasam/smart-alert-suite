        ...
        <div className="campus-card-static p-5 sm:p-6 bg-card border border-border/50 shadow-sm">
          ...
          <div className="flex justify-center">
            <DayPicker
              ...
              modifiersClassNames={{
                highlighted:
                  "relative after:absolute after:bottom-1.5 after:left-1/2 after:-translate-x-1/2 after:w-1.5 after:h-1.5 after:bg-primary after:rounded-full after:ring-1 after:ring-background",
              }}
              ...
              classNames={{
                ...
                caption:
                  "w-full flex justify-between pt-1 relative items-center mb-6 px-4",
                caption_label:
                ...
                nav_button:
                  "h-8 w-8 bg-transparent p-0 text-muted-foreground hover:text-foreground hover:bg-muted rounded-lg transition-all flex items-center justify-center",
                table: "w-full border-collapse space-y-2",
                head_row: "flex justify-between w-full mb-2",
                head_cell:
                  "text-muted-foreground rounded-md w-11 font-bold text-[10px] uppercase tracking-widest text-center",
                ...
                day_selected:
                  "bg-primary text-primary-foreground hover:bg-primary hover:text-primary-foreground focus:bg-primary focus:text-primary-foreground shadow-lg shadow-primary/30 scale-105",
                day_today:
                  "text-primary font-black scale-110 before:absolute before:inset-0 before:border-2 before:border-primary/20 before:rounded-xl",
      ...
      <div className="space-y-4 flex flex-col min-h-[400px]">
        ...
        <div className="flex items-center justify-between p-4 bg-card/80 backdrop-blur-md rounded-2xl border border-border shadow-sm sticky top-[4.5rem] lg:relative lg:top-0 z-10 transition-all">
          ...
          <div className="px-4 py-2 rounded-xl bg-primary text-primary-foreground text-xs font-black uppercase tracking-wider shadow-lg shadow-primary/20">
            {dayAnnouncements.length}{" "}
            {dayAnnouncements.length === 1 ? "Notice" : "Notices"}
          </div>
        </div>
