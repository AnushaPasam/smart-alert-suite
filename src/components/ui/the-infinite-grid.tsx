...
export const Component = ({ children, className }: { children?: React.ReactNode; className?: string }) => {
    ...
    return (
        ...
        >
            ...
            <motion.div
                className="absolute inset-0 z-0 opacity-40 text-primary"
            ...
            <div className="relative z-10 w-full">
                {children ? children : (
                    <div className="flex flex-col items-center text-center px-4 max-w-3xl mx-auto space-y-6 pointer-events-none">
