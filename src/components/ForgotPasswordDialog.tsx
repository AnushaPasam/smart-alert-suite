    ...
    return (
        <Dialog open={open} onOpenChange={setOpen}>
            <DialogTrigger asChild>
                <button type="button" className="text-xs text-primary font-medium hover:underline hover:text-campus-blue transition-colors">
                    Forgot password?
                </button>
            </DialogTrigger>
                ...
                {submitted ? (
                    ...
                    <>
                        <DialogHeader>
                            ...
                            <DialogDescription>
                                Enter your campus email address and we'll send you a link to reset your password.
                            </DialogDescription>
                        </DialogHeader>
                        <form onSubmit={handleSubmit} className="space-y-4 py-4">
                            <div className="space-y-2">
                                <Label htmlFor="reset-email" className="text-sm font-semibold">Campus Email</Label>
                                <Input
                                    id="reset-email"
                                    type="email"
                                    required
